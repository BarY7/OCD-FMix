...
from utils_test_ocd import overfitting_batch_wrapper,noising,generalized_steps,ConfigWrapper
...
for idx, batch in enumerate(test_loader):
    ...
    lbaseline += lbase
    total += 1
    print(predicted_diff.argmax())
    print(predicted_base.argmax())
    print(batch['output'])
